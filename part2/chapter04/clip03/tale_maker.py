...
from enums import Dalles, Ttss
from dalle import get_image_url
from tts import download_audio
...
def chat(input: TaleInput) -> dict:
    ...
    if download_audio("tts-1-hd", res["plot"], Ttss.PESIST_DIRECTORY + Ttss.PLOT_AUDIO):
        res["audio"] = Ttss.PLOT_AUDIO
